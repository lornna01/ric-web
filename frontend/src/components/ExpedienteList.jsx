        ...
        <table className="table">
          <thead className="table-light">
            <tr>
              <td colSpan={5}>
                ...
                <h2 className="text-center position-relative">
                  <span
                    className="mdi mdi-replay text-info position-absolute start-0"
            ...
            <tr>
              ...
              <th className="text-truncate">Leitz</th>
              <th className="text-truncate">Estante</th>
                    ...
                    <td>
                      <span
                        className={`badge bg-label-${item.estado.nombre === "COMPLETO"
                          ? "success"
                          : item.estado.nombre === "SIN ACTA F-28"
                            ? "warning"
                            : "secondary"
                          } rounded-pill`}
                      >

...
const BoletaList = ({ user, boletaList, setMensaje, getBoletas, boleta, setBoleta, setEditing, loading, setLoading, error, setError, deleteBoleta }) => {
      ...
      <div className="table-responsive">
        <table className="table">
          <thead className="table-light">
            <tr>
              <th className="text-truncate">SERIE</th>
              <th className="text-truncate">FECHA</th>
              <th className="text-truncate">PAIS</th>
              <th className="text-truncate">DEPARTAMENTO</th>
              <th className="text-truncate">GENERO</th>
              <th className="text-truncate">EDAD</th>
                ...
                <tr key={item.id}>
                  <td>
                    <div className="d-flex align-items-center">
                      <div>
                        <h6 className="mb-0 text-truncate">{item.serie}</h6>
                      </div>
                    </div>
                  </td>
                  <td className="text-truncate">{item.fecha.substr(0, 10)}</td>
                  <td className="text-truncate">
                    <i className="mdi mdi-map mdi-24px text-danger me-1" />{" "}
                    {item.pais}
                  </td>
            ...
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title" id="exampleModalLabel1">
                  Asignar Combustible al vehículo de placa: <strong>{""}</strong>
                </h5>
                <button
                  type="button"
                  className="btn-close"

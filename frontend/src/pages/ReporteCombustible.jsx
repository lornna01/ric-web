...
const ReporteCombustible = () => {
    ...
    const [idCombustible, setIdCombustible] = useState(0);
    ...
    */
    ...
    const exportarExcel = async () => {
        ...
        const worksheetData = reporteList.map(combustible => ({
            ...
            "Movimiento Combustible": combustible.combustible_id,
        ...
        reader.onloadend = async () => {
            ...
            worksheet.columns = [
                ...
                { width: 20 }, // MOVIMIENTO COMBUSTIBLE
                                ...
                                <div className="col-xxl">
                                    <div className="card mb-4">
                                        <div className="card-header d-flex justify-content-between align-items-center">
                                            <h5 className="mb-0">
                                                <span className="text-muted fw-light">Reportes/</span> combustibles ingresados
                                            </h5>
                                            <button
                                                type="button"
                                        ...
                                        <div className="card-body">
                                            ...
                                            <form>
                                                <div className="input-group">
                                                    ...
                                                    <div className="form-floating form-floating-outline mb-4">
                                                        <select
                                                            disabled={vehiculos.length <= 0} // Cambia 'departamentos' a 'vehiculos'
                                                            id="vehiculo" // Cambia el id a "vehiculo"
                                                            className="form-select form-select-lg"
                                                            value={idVehiculo} // Cambia 'idDepartamento' a 'idVehiculo'
                                                            onChange={(e) => setIdVehiculo(e.target.value)} // Cambia 'setIdDepartamento' a 'setIdVehiculo'
                                                        >
                                                            <option value={0}>--- SELECCIONE ---</option>
                                                            {vehiculos.map((item) => ( // Cambia 'departamentos' a 'vehiculos'
                                                                ...
                                                                <table className="table table-bordered table-custom">
                                                                    <thead>
                                                                        <tr>
                                                                            ...
                                                                            <th scope="col">Movimiento Combustible</th>
                                                                        ...
                                                                        {reporteList.length === 0 ? (
                                                                            <tr>
                                                                                <td colSpan="9" className="text-center">
                                                                                    No se encontraron combustibles para el rango de fechas seleccionado.
                                                                                </td>
                                                                            </tr>
                                                                        ) : (
                                                                            reporteList.map((combustible, index) => (
                                                                                ...
                                                                                <td>{combustible.pdf}</td>                         {/* PDF */}
                                                                                <td>{combustible.observacion_cupon}</td>          {/* Observaciones */}
                                                                                <td>{combustible.combustible_id}</td>             {/* Movimiento Combustible */}
